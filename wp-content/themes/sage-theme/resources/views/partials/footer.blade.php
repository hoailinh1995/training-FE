<footer id="footer" class="module footer w-full">
  <div class="tong">
    <div class="bg-cover h-300 w-full relative" style="background-image: url(@asset('images/Footerbackground.png'))">
      <div class="hinh1  absolute top-30-per left-35-per 2xl:left-5-per 2xl:top-62-per lg:left-1-per lg:top-48-per ">
        <img src="@asset('images/Footer1.png')" alt="hinh">
      </div>
      <div class="hinh2  absolute top-40-per left-38-per 2xl:left-6-per 2xl:top-74-per lg:left-2-per lg:top-57-per  ">
        <img src="@asset('images/Footer2.png')" alt="hinh">
      </div>
      <div class="content row w-full  absolute top-48-per pl-5-per 2xl:w-64-per 2xl:left-21-per 2xl:top-71-per  lg:pl-0 lg:w-64-per lg:top-71-per lg:left-21-per">
      ...
      <div class="nut border-4 border-white text-white  rounded-full  absolute top-60-per left-38-per text-center w-20-per 2xl:left-82-per 2xl:top-71-per 2xl:w-15-per lg:left-75-per lg:top-47-per">
