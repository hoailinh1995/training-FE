<section class="container lg:pl-45 xl:pl-25 pl-153 2xl:pl-80 ">
    <div class="lg:row w-585">
        ...
        <div
            class="Icon2 row  pl-5 mt-2-per lg:w-1/3 lg:w-175 xl:w-200 lg:border-r-4 border-b-4 lg:border-b-0 w-92 text-center  border-gray-300">
            <div class="mid">
        ...
        <div class="Icon3 row lg:w-1/3 text-center pt-10 -ml-4-per  ">
            <div class="right">
