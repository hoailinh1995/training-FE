<section class="module-abc font-poppins ">
  ...
  <div class="container">
    <div class="row w-100-per">
      <div class="left col xx:w-37-per xx:-ml-45 lg:w-1/2 2xl:w-1/2 2xl:pl-10-per">
      <div class="border-t-1 w-30-per bg-orange mb-15 ml-1 h-2"></div>
      <div class="text-4xl font-bold">
        <h2 class="leading-10">The encompass Platform Seamlessly Connectes the Supply Chain, Allowing You to:</h2>
      </div>
      </div>
      <div class="right col xx:w-63-per xx:ml-35">
        <div class="row ">
        <div class="trai col w-45-per md:w-1/2  ">
          <div class="a">
            <div class="drive">
              <h3>Drive Business Growth</h3>
            </div>
            <div class="xx:w-90-per">
        ...
        <div class="phai col w-45-per md:w-1/2">
          <div class="c">
            <div class="Leverage xx:w-70-per">
    ...
    <div class="slide xx:w-900 xx:mt-70 bg-white rounded-4xl shadow-2xl m-auto relative z-1">
      <div class="slick_slide">
        <div class="p-46">
          <div class="pr-100 text-4xl font-bold">
            <h2>
      ...
      <div class="button_slick w-100 absolute z-2 text-3xl bottom-25 -right-9 "></div>
    </div>
  </div>
</section>