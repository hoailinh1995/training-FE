    ...
    <div class="container mt-50">
        ...
        <div class="logo">
            <div class="slick_slide3 w-90-per m-auto ">
                <div class="w-full">
                    <div class="lg1 w-13-per float-left ml-56"><img class="" src="@asset('/images/1.png')"></div>
                    <div class="lg2 w-13-per float-left ml-18 -mt-5"><img class="" src="@asset('/images/2.png')"></div>
                    <div class="lg3 w-13-per float-left -mt-4 ml-16"><img class="" src="@asset('/images/3.png')"></div>
                    <div class="lg4 w-13-per float-left -mt-1 ml-9"><img class="" src="@asset('/images/4.png')"></div>
                    <div class="lg5 w-13-per float-left mt-2 ml-7"><img class="" src="@asset('/images/5.png')"></div>
                    <div class="lg6 w-13-per float-left -mt-1 -ml-8"><img class="" src="@asset('/images/6.png')"></div>
                </div>
                <div class="w-full">
                    <div class="lg1 w-13-per float-left ml-56"><img class="" src="@asset('/images/1.png')"></div>
                    <div class="lg2 w-13-per float-left ml-18 -mt-5"><img class="" src="@asset('/images/2.png')"></div>
