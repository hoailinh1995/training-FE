...
<!-- <section class="module_7 bg-white w-full m-auto"> -->
    <div class="container -mt-7">
        ...
        <img class="-ml-35" src="@asset('images/hinh_6.png')" alt="picture">

        <img class="ml-23 h-22" src="@asset('images/hinh_7.png')" alt="picture">

        <img class="ml-23" src="@asset('images/hinh_8.png')" alt="picture">

        <img class="ml-23 h-22" src="@asset('images/hinh_9.png')" alt="picture">

        <img class="ml-25" src="@asset('images/hinh_10.png')" alt="picture">
        </div>
    ...
    <div class="container">
        <div class="flex flex-row flex-wrap w-full items-center	">
            <div class="picture h-auto -ml-38 p-0 w-1/2">
                <img class="" src="@asset('images/hinh_4.png')" alt="picture">
            </div>
            ...
            <div class="slick w-1/2">
                <div class="slick_slide1">
                    <div class="picture h-auto p-33 -mt-21 w-1/2">
                        <img class=" m-37 mt-46 " src="@asset('images/hinh_5.png')" alt="picture">
                    </div> 
                    <div class="picture h-auto p-33 -mt-21 w-1/2">
                        <img class=" m-37 mt-46 " src="@asset('images/hinh_5.png')" alt="picture">
                    </div> 
...
<!-- <section class="Module-Flower"> -->
    <div class="Container">
        ...
        <div class="content1 w-full lg:w-1/3 lg:border-r-2 lg:border-b-0 border-b-2 p-0 lg:p-40  lg:m-0 mx-30 my-40 border-green-200">
            ...
            <img class="" src="@asset('images/hinh_1.png')" alt="picture1">
            </div>
        ...
        <div class="content2 w-full lg:w-1/3 lg:border-b-0 border-b-2 p-0 lg:p-40 lg:m-0 mx-30 my-40  border-green-200">
            ...
            <img class="" src="@asset('images/hinh_2.png')" alt="picture2">
            </div>
        <h3 class="font-bold text-left text-5xl">
            Scalable,
        </h3>
        ...
        <div class="content3 w-full lg:w-1/3 lg:border-l-2 p-0 lg:p-40 lg:m-0 mx-30 my-40 lg:border-green-200">
            ...
            <img class="" src="@asset('images/hinh_3.png')" alt="picture3">
            </div>
        <h3 class="font-bold text-left text-5xl">
            Backed by
        </h3>
        ...
        <div class="flex flex-row flex-wrap w-full">
            <div class="left xx:w-1/2 xx:ml-48 w-full lg:w-1/2 p-4 ">
                <div class="bg-white rounded-3xl shadow-2xl">
                    <div class="w-full h-114 bg-center bg-cover rounded-t-3xl rounded-lg" style="background-image: url(@asset('images/May-27.jpg'));">
                    </div>
                    <div class="p-8">
                        <div class="font-bold">
                            <h3>
