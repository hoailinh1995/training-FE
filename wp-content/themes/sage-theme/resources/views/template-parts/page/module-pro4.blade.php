<section class="mod_pro4 relative lg:bottom-25 2xl:top-15 font-poppins">
    <div class="continer text-center">
        <div class="Block_a">
            ...
            <div class="Body_0 sm:pr-78 sm:pl-70">
        ...
        <div class="Block_b relative row">
            <div class="content1 w-full lg:w-1/3 pb-65 relative">
                <div class="Icon1 sm:pt-45"><span class="icomoon icon-Group-2461 text-7xl"></span></div>
                <div class="Head1 ">
                    <h3>Solutions for Manufacturers</h3>
                </div>
                <div class="Body1 sm:pl-74 sm:pr-74 lg:pl-33 lg:pr-20 ">
            ...
            <div class="content2 w-full lg:w-1/3  pb-65 relative lg:pt-10">
                ...
                <div class="Head2 sm:pt-11 ">
                    <h3>Solutions for Distributors</h3>
                </div>
                <div class="Body2 sm:pl-68 sm:pr-55 lg:pl-15 lg:pr-11">
                ...
                <div class="footer2 text-orange sm:pt-13">
                    <h7>EXPLORE ORCHESTRA <span class="icomoon icon-Group-2455"></span></h7>
