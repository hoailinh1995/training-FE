<section class="module-Header font-poppins w-full">
    <div class="bg-cover right-0 left-0 top-0 bottom-0 xx:h-912 xx:w-1925 2xl:w-1441 2xl:h-773 lg:h-781 md:h-816 absolute z-1" alt="BG" style="background-image:url(<?= \App\asset_path('images/BG1.png'); ?>)" ></div>
