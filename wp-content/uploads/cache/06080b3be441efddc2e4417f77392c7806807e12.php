<section class="module-Header font-poppins w-full">
    <div class="bg-cover right-0 left-0 top-0 bottom-0 xx:h-912 xx:w-1919 2xl:w-1441 2xl:h-773 lg:h-781 md:h-816 absolute z-1" style="background-image:url(<?= \App\asset_path('images/BG1.png'); ?>)" ></div>
    ...
    <div class="container w-full absolute xx:top-18.5 xx:left-375 z-3 2xl:left-144 2xl:top-19 lg:left-50 md:top-18 md:left-63">
        ...
        <div class="bot lg:text-left lg:w-40-per xx:mt-90 xx:-ml-7 2xl:mt-69 2xl:-ml-8 lg:mt-62 lg:-ml-8 md:w-85-per md:-ml-6 md:mt-51 md:text-center">
            ...
            <div class="image w-65-per">
                <div class="bg-cover right-0 bottom-0 absolute z-2 xx:h-690 xx:w-1510 xx:top-73 xx:left-19 2xl:top-31 2xl:left-7 2xl:w-1283 2xl:h-714 lg:top-106 lg:left-3 lg:h-515 lg:w-1100 md:w-1182 md:h-614 md:top-414 md:-left-437" style="background-image:url(<?= \App\asset_path('images/lap1.png'); ?>)" ></div>
                <div class="bg-cover absolute z-2 xx:h-500 xx:w-330 xx:top-315 xx:left-663 xl:h-500 2xl:w-318 2xl:left-640 2xl:top-303 lg:h-450 lg:w-200 lg:top-286 lg:right-352 md:w-242 md:h-532 md:top-628 md:right-420" style="background-image:url(<?= \App\asset_path('images/phone1.png'); ?>)" ></div>
            </div>
        </div>
    </div>
</section>