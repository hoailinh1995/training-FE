<!-- <section class="module-abc">
  <div class="warp   ">
    <div class="row">
      <div class="col w-full lg:w-1/2 left w:26rem;">
        <div class="the">
          <h2>The Encompass Platform Seamlessly Connectes the Supply Chain, Allowing You to:</h2>
        </div>
      </div>
      <div class="col w-full lg:w-1/2  right w:26rem;">
        <div class="trai">
          <div class="a">
            <div class="drive bg-green-100">
...
<!--<section class="mod-abc">
  <div class="container">
    <div class="row">
      <div class="col w-full lg:w-1/2 left w:26rem;">
        <div class="the w-20-per">
          <h2>The Encompass Platform Seamlessly Connectes the Supply Chain, Allowing You to:</h2>
        </div>
      </div>
      <div class="col w-full lg:w-1/2  right w:26rem;">
  ...
  <div class="container">
    <div class="row w-100-per bg-white">
      ...
      <div class="right col w-full lg:w-1/2">
        <div class="trai float-left w-50-per">
          <div class="a">
            <div class="drive">
              <h3>Drive Business Growth</h3>
            </div>
