<section class="module-TheLatest">
<meta name="viewport" content="width-device-width, initial-scale=1">
    <div class="container">
        <p>THE LATEST</p>
        <div class="flex flex-row w-full">
            <div class="left w-full lg:w-1/2 bg-yellow rounded-3xl">
            ...
            <div class="flex flex-col w-full lg:w-1/2">
                <div class="up md:w-1/2 w-full bg-green-100 rounded-3xl">
                <h3>
                    Lorem ipsum dolor sit amet, consetetur
                </h3>
                <p>
                ...
                <div class="down w-full md:w-1/2  bg-red-400 rounded-3xl">
                    <h3>
                        Lorem ipsum dolor sit amet, consetetur
                    </h3>
                    <p>
