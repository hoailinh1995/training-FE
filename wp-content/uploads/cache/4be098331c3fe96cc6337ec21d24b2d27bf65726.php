<section class="container text-center">
    ...
    <div class="Block_a">
        <div class="Head_0 w-60-per ml-22-per">
            <h2>Enterprise ERP Solutions for Beverage & Food Industry </h2>
        </div>
        <div class="Body_0 w-60-per ml-22-per">
    ...
    <div class="Block_b">
        <div class="content1">
            <div class="Icon1"><span class="icon-Group-2461 text-7xl"></span></div>
            <div class=" mt-5-per">
                <div class="Head1">
                    <h3>Solutions for Manufacturers</h3>
                </div>
                <div class="Body1 w-60-per ml-21-per">
                ...
                <div class="footer1">
                    <h6>EXPLORE ORCHESTRA <span class="icon-Group-2530"></span></h6>
                </div>
            </div>
        </div>

        <div class="Pic1 pl-47-per">
            <img src="<?= \App\asset_path('images/ANH2591.png'); ?>" alt="hinh">
        </div>

        <div class="content2 mt-4-per">
            <div class="Icon2"><span class="icon-Path-5210 text-7xl"></span></div>
            <div class=" mt-3-per">
                <div class="Head2">
                    <h3>Solutions for Distributors</h3>
                </div>
                <div class="Body2 w-70-per ml-15-per">
        ...
        <div class="Pic2 pl-47-per">
            <img src="<?= \App\asset_path('images/ANH2591.png'); ?>" alt="hinh">
        </div>

        <div class="content3 mt-4-per">
            <div class="Icon3"><span class="icon-store-line text-7xl"></span></div>
            <div class="">
                <div class="Head3 mt-3-per">
                    <h3>Solutions for Retailers</h3>
                </div>
                <div class="Body3 w-65-per ml-17-per">
