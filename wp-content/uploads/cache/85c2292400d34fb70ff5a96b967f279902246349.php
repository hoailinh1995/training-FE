        ...
        <div class="logo">
            <div class="slick_slide3 w-90-per m-auto">
                <div class="w-full text-center align-middle">
                    <div class="lg1 w-1/6 float-left"><img class="" src="<?= \App\asset_path('/images/1.png'); ?>"></div>
                    <div class="lg2 w-1/6 float-left"><img class="" src="<?= \App\asset_path('/images/2.png'); ?>"></div>
                    <div class="lg3 w-1/6 float-left"><img class="" src="<?= \App\asset_path('/images/3.png'); ?>"></div>
                    <div class="lg4 w-1/6 float-left"><img class="" src="<?= \App\asset_path('/images/4.png'); ?>"></div>
                    <div class="lg5 w-1/6 float-left"><img class="" src="<?= \App\asset_path('/images/5.png'); ?>"></div>
                    <div class="lg6 w-1/6 float-right"><img class="" src="<?= \App\asset_path('/images/6.png'); ?>"></div>
                </div>
                <div class="w-full text-center align-middle">
                    <div class="lg1 w-1/6 float-left"><img class="" src="<?= \App\asset_path('/images/1.png'); ?>"></div>
                    <div class="lg2 w-1/6 float-left"><img class="" src="<?= \App\asset_path('/images/2.png'); ?>"></div>
                    ...
                    <div class="lg4 w-1/6 float-left"><img class="" src="<?= \App\asset_path('/images/4.png'); ?>"></div>
                    <div class="lg5 w-1/6 float-left"><img class="" src="<?= \App\asset_path('/images/5.png'); ?>"></div>
                    <div class="lg6 w-1/6 float-left"><img class="" src="<?= \App\asset_path('/images/6.png'); ?>"></div>
                </div>
            </div>
