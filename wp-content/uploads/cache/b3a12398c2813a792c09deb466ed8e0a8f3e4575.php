            ...
            <div class="NoiDung">
                <div class="Tren row xx:h-44 xx:pl-393 xx:pt-5 2xl:h-46 2xl:pl-21 2xl:pt-6 border-b-1 border-white sm:h-57">
                    <div class="logo xx:w-20-per xx:ml-0 xx:pl-0  xx:pt-2 sm:ml-40 sm:mt-20 lg:pl-20 lg:pt-3 2xl:mt-0 2xl:pl-6 2xl:pt-15">
                        <img src="<?= \App\asset_path('images/header2.png'); ?>" alt="hinh">
                    </div>
                    <div class="content row xx:pt-0 xx:w-80-per text-white  xx:pl-26 2xl:pt-17 2xl:pl-267 lg:pt-23 lg:pl-31">
                        <div class="content1 xx:w-1/4 hover:text-yellow">
                           <button><h5>ABOUT US</h5></button>
                        </div>
                        <div class="content2 xx:w-1/4 2xl:pl-37 hover:text-yellow">
                         <button><h5>LEADERSHIP</h5></button>   
                        </div>
                        <div class="content3 xx:w-1/4 2xl:pl-32 hover:text-yellow">
                           <button><h5>CAREERS</h5></button>
                        </div>
                        <div class="content4 xx:w-1/4 pl-35 hover:text-yellow">
                ...
                <div class="Duoi text-white row xx:pl-20-per relative 2xl:pl-68 2xl:pt-19">
                    <div class="alpha 2xl:pt-0 2xl:w-1100  2xl:pl-0 xx:pt-5 sm:pl-76 sm:mt-73 lg:pl-60 lg:pr-508 lg:mt-47 ">
                        <div class="tieude 2xl:pr-50">
                            <h1>Unlock the Power of Connection</h1>
                        </div>
                        <div class="noidung 2xl:pt-8 2xl:pr-82 ">
                            <p>Connect & Grow Your Business with the Power of the Encompass Platform</p>
                        </div>
                        <div class="nut bg-orange hover:text-yellow text-center rounded-full 2xl:w-233 2xl:h-24 2xl:mt-19 sm:w-245 sm:p-5 sm:mt-35 sm:h-26 sm:ml-63 lg:ml-0 ">
                    ...
                    <div class="hinh sm:left-100 sm:top-392 sm:w-909 absolute 2xl:w-1030 2xl:left-635 2xl:top-77   xx:left-900 xx:w-1030 lg:left-458 lg:top-88 lg:w-768">
                        <img src="<?= \App\asset_path('images/header1.png'); ?>" alt="hinh">
                    </div>
                </div>
...
<!-- <header id="header" class="module header w-full top-0 left-0 fixed z-200 down_lg:overflow-hidden">
    <div class="container">
        <div class="bg-cover " style="background-image: url(<?= \App\asset_path('images/Headerbackgroundprovip.png'); ?>)">
            <nav class="row navbar items-center">
                <div class="col w-full down_lg:flex down_lg:flex-wrap lg:w-1/5 header-mobile relative justify-between items-center">
                    <div class="lg:w-full relative">
                        <a id="header-logo" class="navbar-brand header-logo py-5 inline-block align-middle" href="<?php echo App::getLogo()['href']; ?>">
