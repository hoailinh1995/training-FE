<section class="module-Header font-poppins w-full ">
    ...
    <div class="container absolute z-2 top-21 left-360">
        ...
        <div class="pic xx:w-60-per">
            <div class="pic absolute w-71-per top-130 -right-173"><img src="<?= \App\asset_path('/images/lap.png'); ?>" alt=""></div>
            <div class="phone absolute top-370 right-430"><img src="<?= \App\asset_path('/images/phone.png'); ?>" alt=""></div>
        </div>
    </div>
</section>