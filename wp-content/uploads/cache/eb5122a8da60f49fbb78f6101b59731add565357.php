<section class="module-Header font-poppins xx:w-full">
    <div class="bg-cover -left-2 right-0 top-0 bottom-0 xx:h-943 2xl:h-794 md:h-835 absolute z-1" style="background-image:url(<?= \App\asset_path('/images/header.png'); ?>)" ></div>
